<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Form Edit Member</h2>
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="inputEmail3" value="<?php echo $member->namaKonsumen; ?>" name="namaKonsumen" placeholder="Nama Konsumen">
                            </div>
                        </div>
                    </div>
